...
<script>
  ...
  import ListViewPage from './components/ListViewPage.svelte'
  import TextNodePage from './components/TextNodePage.svelte'
  import SegmentedBarPage from './components/SegmentedBarPage.svelte'
  import FormattedStringPage from './components/FormattedStringPage.svelte'
